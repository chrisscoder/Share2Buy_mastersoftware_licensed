...
require('angular-consent/dist/angular-consent.js');
require('angular-socialshare');
require('angular-i18n/angular-locale_da');
require('./modules/template-cache.js'); // Template cache should make it a littlebit faster
...
require('picturefill');
require('./vendor/angular-datepicker-2.0.3/dist/angular-datepicker');
...
var app = angular.module('app', [
  ...
  // ROUTING er lignende LARAVEL
  .config(['$provide', '$httpProvider', '$compileProvider', '$locationProvider', function($provide, $httpProvider, $compileProvider, $locationProvider) {
    ...
    // Laravel doesn't seem to work with html5mode. It breaks its routing
  ...
  .controller('ProductUIController',['$scope', '$filter', function($scope, $filter){
    $scope.dates = {
      today: moment.tz('Europe/Copenhagen').add(30, 'm'),
      minDate: moment.tz('Europe/Copenhagen'),
      maxDate: moment.tz('Europe/Copenhagen').add(4, 'd'),
    };

    $scope.dateValidation = function(modelDate, minDate){
      return modelDate >= minDate;
    };
  ...
  // https://gist.github.com/mhmli/981f244ed8d18e00a053cd5429abf908
